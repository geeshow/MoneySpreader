...
public class SpreaderConstant {
    ...
    public static final int EXPIRE_DAYS_OF_SPREAD = 7; // 조회 유효 시간: 7일
    public static final int EXPIRE_MINUTES_OF_RECEIPT = 10; // 수취 유효 시간: 10분
    public static final int MINIMUM_SPREAD_AMOUNT = 1; // 최소 뿌리기
    public static final int START_RECURSICE_COUNT = 0; // 재귀 호출 제한 시작 수
    public static final int MAXIMUM_RECURSICE_COUNT = 10; // 재귀 호출 제한 수
